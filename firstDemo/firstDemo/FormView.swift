...
struct FormView: View {
                ...
                VStack {
                    ...
                    Form {
                        ...
                        Section(header: Text("Description")) {
                            VStack {
                                TextField("Add your contacts, description of animal", text: $addNewSubtitle)
                                
                            }
                        }
                    }.foregroundColor(Color("listCl"))
                    onAddButton.disabled(addNewSubtitle.isEmpty || addNewNumber.isEmpty || gender.isEmpty || animalType.isEmpty)
                }
                .navigationBarTitle("Add new request")
                .navigationBarItems(trailing: Button("Cancel") { showForm = false })
    ...
    var onAddButton: Button<Text> {
        Button(action: {
            ...
            Text("Add new request").foregroundColor(.accentColor)
        }
    }
}
